...
subtitle <- paste0(
  ...
  "<span style = 'font-family:Chivo; color:",
  team_color_2,
  "'><b>Red bar</b> shows the % of team dropbacks where the player was targeted"
)
...
ggsave(test_plot,
       filename = "Plots without Logos/lv utilisation facet.png",
       units = "in",
       height = 9,
       width = 9)
...
vegas_pass_game_facet_with_logo <- add_logo(
  plot_path = "Plots without Logos/lv utilisation facet.png", # url or local file for the plot
...
magick::image_write(vegas_pass_game_facet_with_logo,
                    "Plots with Logos/vegas_pass_game_facet_with_logo.png")

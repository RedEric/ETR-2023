...
subtitle <- paste0(
  ...
  team_color_1,
  "'><b>Dark Green</b> bar shows % of team dropbacks where player ran a route<br>",
  "<span style = 'font-family:Chivo; color:",
  team_color_2,
  "'><b>Bright green bar</b> shows the % of team dropbacks where the player was targeted"
)
...
ggsave(test_plot,
       filename = "Plots without Logos/orl utilisation facet.png",
       units = "in",
       height = 9,
       width = 9)
...
orlando_pass_game_facet_with_logo <- add_logo(
  plot_path = "Plots without Logos/orl utilisation facet.png", # url or local file for the plot
...
magick::image_write(orlando_pass_game_facet_with_logo,
                    "Plots with Logos/orlando_pass_game_facet_with_logo.png")

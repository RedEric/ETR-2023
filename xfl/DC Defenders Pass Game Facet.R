...
ggsave(test_plot,
       filename = "Plots without Logos/dc utilisation facet.png",
       units = "in",
       height = 9,
       width = 9)
...
dc_pass_game_facet_with_logo <- add_logo(
  plot_path = "Plots without Logos/dc utilisation facet.png", # url or local file for the plot
...
magick::image_write(dc_pass_game_facet_with_logo,
                    "Plots with Logos/dc_pass_game_facet_with_logo.png")

...
ggsave(hou_dark_plot,
       filename = "Plots without Logos/hou dark utilisation facet.png",
       units = "in",
       height = 9,
       width = 9)
...
hou_pass_game_facet_with_logo <- add_logo(
  plot_path = "Plots without Logos/hou dark utilisation facet.png", # url or local file for the plot
...
magick::image_write(hou_pass_game_facet_with_logo,
                    "Plots with Logos/houston_pass_game_facet_with_logo_dark.png")

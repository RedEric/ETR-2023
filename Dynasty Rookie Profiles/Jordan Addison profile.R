...
player_full_name <- "Jordan Addison"
player_first_name <- "Jordan"
player_surname <- "Addison"
player_position <- "WR"
...
player_armlength <- ""
player_wingspan <- 
headshot_url <- "https://a.espncdn.com/combiner/i?img=/i/headshots/college-football/players/full/4429205.png&w=350&h=254"

# College History
years <- c(2020,2021,2022)
college <- c("Pittsburgh",
             "Pittsburgh",
             "Southern California")

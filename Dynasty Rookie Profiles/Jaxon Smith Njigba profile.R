...
player_handsize <- "insert"
player_armlength <- "insert"
player_wingspan <- "insert"
# Get url from espn site
...
data <- data %>% 
  ...
  mutate(column_headers = case_when(
    measure == "games" ~ "GAMES",
    measure == "ms_rush_yd" ~ "SHARE OF<br>RUSH YARDS",
    measure ==  "ms_touches" ~ "SHARE OF<br>TOUCHES",
    measure == "dom" ~ "DOMINATOR<br>RATING",
    measure == "rec_yd_pta" ~ "RECEIVING YDS<br>PER TEAM ATTEMPT",
